...
import pandas as pd
from hktxgnn.collectors import DrugBundleAggregator
from hktxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from hktxgnn.collectors.drug_bundle import PredictedIndication
...
def patch_single_drug(
    ...
    """
    from hktxgnn.collectors.drug_bundle import DrugBundle
